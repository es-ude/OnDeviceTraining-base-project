...
execute_process(
  COMMAND "/nix/store/6qbj40r0s289k5slmy8yna5x2hfz01wg-git-2.53.0/bin/git" --git-dir=.git show-ref "2.2.0"
  WORKING_DIRECTORY "/Users/leo/work/OnDeviceTraining-base-project/pico-sdk/src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/leo/work/OnDeviceTraining-base-project/pico-sdk/src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/leo/work/OnDeviceTraining-base-project/pico-sdk/src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
